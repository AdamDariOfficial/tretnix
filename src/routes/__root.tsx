...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Tretnix sviluppa gestionali, dashboard, CRM e automazioni su misura per aziende che vogliono semplificare i processi e lavorare meglio." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Tretnix — Software Studio" },
      { name: "twitter:description", content: "Tretnix sviluppa gestionali, dashboard, CRM e automazioni su misura per aziende che vogliono semplificare i processi e lavorare meglio." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b910b878-7bb5-4d9b-bb9f-32ced030903d/id-preview-cd5ba1aa--3890cdf7-1438-49ed-a05a-c5342604f055.lovable.app-1783157001303.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b910b878-7bb5-4d9b-bb9f-32ced030903d/id-preview-cd5ba1aa--3890cdf7-1438-49ed-a05a-c5342604f055.lovable.app-1783157001303.png" },
    ],
    links: [
